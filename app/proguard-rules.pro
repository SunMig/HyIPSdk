...
#引入依赖包rt.jar（jdk路径）
-libraryjars 'F:\Android\android studio\jre\jre\lib\rt.jar'
#引入依赖包android.jar(android SDK路径)
-libraryjars 'F:\Android\sdk\platforms\android-25\android.jar'
#如果用到其他包，需要引入
...
-keep class com.bjx.cumt.hyipsdk.FusionFilter.MHybLocHandler